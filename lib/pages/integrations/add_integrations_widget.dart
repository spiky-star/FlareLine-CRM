...
class AddIntegrationsWidget extends BaseStlessWidget<AddIntegrationsViewModel> {
  AddIntegrationsWidget({super.key});

  @override
  Widget bodyWidget(
      BuildContext context, AddIntegrationsViewModel viewModel, Widget? child) {
    return ButtonWidget(
      btnText: 'Add Integrations +',
  ...
  @override
  AddIntegrationsViewModel viewModelBuilder(BuildContext context) {
    return AddIntegrationsViewModel(context);
  }
}

class AddIntegrationsViewModel extends BaseTableProvider {
  AddIntegrationsViewModel(super.context);
